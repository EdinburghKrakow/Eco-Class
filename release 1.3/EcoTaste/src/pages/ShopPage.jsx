...
function ShopPage({
  ...
  const renderCategories = () => (
    <div className="categories-section">
      <button className="category-slider-btn prev" onClick={() => scrollCategories('prev')} aria-label="Предыдущие категории"> ← </button>
      ...
      <button className="category-slider-btn next" onClick={() => scrollCategories('next')} aria-label="Следующие категории"> → </button>
    </div>
  );
  ...
  return (
    <div className="App">
      ...
      {/* under_home.png отдельно от header, но выше категорий */}
