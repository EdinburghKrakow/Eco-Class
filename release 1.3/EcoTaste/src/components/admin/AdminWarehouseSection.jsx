...
function AdminWarehouseSection({
  ...
  const handleStartInlineEdit = (item) => {
    ...
    setEditForm({
      ...
      category: item.category || '',   // ← подгружаем категорию
    });
  };
  ...
  const handleSaveInlineEdit = () => {
    handleUpdateGood({
      ...
      category: editForm.category,   // ← передаём категорию
    });
    setEditingId(null);
  };
                ...
                <td>
                  {isEditing ? (
                    <select
                      ...
                      onChange={(e) => handleInlineFormChange('category', e.target.value)}
                      className="admin-inline-input"
                    >
                      {categories.map((cat) => (
          ...
          <div className="admin-form-grid">
            ...
            <label className="admin-form-label">
              ...
              <select
                ...
                onChange={(e) => handleAdminFormChange('category', e.target.value)}
                className="admin-form-input"
              >
                {categories.map((cat) => (
                  <option key={cat} value={cat}>
