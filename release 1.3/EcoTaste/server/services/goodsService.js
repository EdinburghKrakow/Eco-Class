...
export const createGood = async (goodData) => {
  const { id, name, price, quantity, isnew, seller } = goodData;
  await pool.query(
    `INSERT INTO goods (id, name, photo, description, price, quantity, isnew, seller)
     VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`,
    [id, name, `${id}.png`, `${id}.txt`, price, quantity, isnew, seller]
  );
  return { id, name, price, quantity, isnew, seller };
};
